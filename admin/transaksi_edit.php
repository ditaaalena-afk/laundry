...
<div class="container">
    <div class="panel">
        ...
        <div class="cpl-md-8 c0l-offset-2">
            ...
            // mengambil data pelanggann yang ber id di atas dari tabel pelanggan
            ...
            while($t=mysqli_fetch_array($transaksi)){
                ...
                <form method="post" action="transaksi_update.php">
                     ...
                     <div class="form-group">
                        ...
                        <select class="form-control" name="pelanggan" required="required">
                            ...
                            while($d=mysqli_fetch_array($data)){
                                ?>
                                <option <?php if($d['pelanggan_id'] == $t['transaksi_pelanggan']){ echo "selected='selected'"; } ?>
                 ...
                 <table class="table table-bordered table-striped">
                    ...
                    // menampilkan pakaian-pakaian dari transaksi yang id di atas
                    ...
                    while($p=mysqli_fetch_array($pakaian)){
                        ...
                        <tr>
                            ...
                            <td><input type="umber" class="form-control" name="jumlah_pakaian[]"></td>
                        </tr>
                        <tr>
                            <td><input type="text" class="form-control" name="jenis_pakaian[]"></td>
                            <td><input type="umber" class="form-control" name="jumlah_pakaian[]"></td>
